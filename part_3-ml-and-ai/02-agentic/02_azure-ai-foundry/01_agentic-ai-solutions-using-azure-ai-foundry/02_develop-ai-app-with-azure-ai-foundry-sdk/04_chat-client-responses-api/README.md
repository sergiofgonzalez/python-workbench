# 04: Creating a chat (using the new Responses API) using Azure AI Foundry SDK
...
The project uses the [Responses API](https://platform.openai.com/docs/guides/responses-vs-chat-completions?api-mode=responses) instead of the Chat Completion API.
