"""Entry point for the Mortgage Calculator Streamlit application."""
...
home_value = col1.number_input("Home Value", min_value=0, value=500_000)
deposit = col1.number_input("Deposit", min_value=0, value=100_000)
