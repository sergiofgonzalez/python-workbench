"""Illustrates how to create a typed list by subclassing the list class."""
...
class TypedList(list):
    ...
    def __init__(
        ...
        # this initializes the base list but feels a bit weird as we don't have
    ...
    def __setitem__(self, index: int, item: object) -> None:  # ty:ignore[invalid-method-override]
        ...
        self._validate_type(item)
        # Call the superclass method to actually set the item
